 ...
 * because a requested user doesn't exist.
 */
public class HearThisUserException extends HearThisException {
    /**
     * Constructs a new exception with the specified detail message and username.
     * @param message The detail message (which is saved for later retrieval by the Throwable.getMessage() method).
     * @param username The HearThis username which wasn't found.
     */
    public HearThisUserException(@NotNull String message, @NotNull String username) {
        super(message);
        this.username = username;
    }

    /** The HearThis username which wasn't found. */
    @NotNull
